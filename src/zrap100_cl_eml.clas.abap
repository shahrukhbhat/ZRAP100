CLASS zrap100_cl_eml DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap100_cl_eml IMPLEMENTATION.
...
*    COMMIT ENTITIES
*      RESPONSE OF ZRAP100_R_TravelTP
